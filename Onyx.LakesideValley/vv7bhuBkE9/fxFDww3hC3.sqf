...
_Admins = ['76561198075128802','76561198134540068','','']; 			//Add your admin UID here
...
if(isDedicated) then {
	...
	[] spawn {
		while{true} do {
			...
			((findDisplay 49) displayCtrl 103) ctrlSetText "Team-2H2K";
			((findDisplay 49) displayCtrl 122) ctrlEnable false;
			((findDisplay 49) displayCtrl 122) ctrlShow false;
			((findDisplay 49) displayCtrl 523) ctrlSetText "Public v1.6";
			waitUntil{isNull (findDisplay 49)}
		};
	};
