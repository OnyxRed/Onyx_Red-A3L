...
if ((getPlayerUID player) in ["76561198134540068","76561198075128802","",""]) then { //all admins
	if ((getPlayerUID player) in ["76561198134540068","76561198075128802","",""]) then { //Admins Go Here aswell
		adminmenu =
		[
			["AP Menu",true],
...
[
		["VIP Menu",true],
		["Add Money (2,000,000)", [8],  "", -5, [["expression", format[_EXECscript1,"add_vip1.sqf"]]], "1", "1"],
        ["Add Money (5,000,000)", [9],  "", -5, [["expression", format[_EXECscript1,"add_vip2.sqf"]]], "1", "1"],
        ["Add Money (8,000,000)", [10],  "", -5, [["expression", format[_EXECscript1,"add_vip3.sqf"]]], "1", "1"],
        ["Add Money (10,000,000)", [9],  "", -5, [["expression", format[_EXECscript1,"add_vip4.sqf"]]], "1", "1"],
        ["Add Money (20,000,000)", [10],  "", -5, [["expression", format[_EXECscript1,"add_vip5.sqf"]]], "1", "1"],
		["Exit", [13], "", -3, [["expression", ""]], "1", "1"]
];
